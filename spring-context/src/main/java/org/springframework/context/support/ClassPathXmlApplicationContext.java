...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	public ClassPathXmlApplicationContext(
		...
		//最终会在AbstractApplicationContext中new一个PathMatchingResourcePatternResolver，用于读取spring bean定义资源文件,代码如下：
				//		//AbstractApplicationContext继承DefaultResourceLoader，因此也是一个资源加载器
				//		//Spring资源加载器，其getResource(String location)方法用于载入资源
				//		return new PathMatchingResourcePatternResolver(this);
		super(parent);
		//AbstractRefreshableConfigApplicationContext父抽象类中解析bean定义资源文件的路径，里面调用resolvePath将字符串解析为路径
		//最后存在AbstractRefreshableConfigApplicationContext定义的configLocations数组中
